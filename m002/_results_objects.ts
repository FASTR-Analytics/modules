...
export const resultsObjects: ResultsObjectDefinitionJSON[] = [
  {
    ...
    "description": "Dataset including facility-level adjusted volumes for all adjustment scenarios",
  ...
  },
  {
    ...
    "description": "Dataset including admin-level adjusted volumes for all adjustment scenarios"
  },
  {
    "id": "M2_adjusted_data_national.csv",
    "description": "Dataset including national-level adjusted volumes for all adjustment scenarios"
  },
  {
    "id": "M2_low_volume_exclusions.csv",
    "description": "Tracks indicators potentially excluded from adjustment due to low volume",
    "createTableStatementPossibleColumns": {
      "indicator_common_id": "TEXT NOT NULL",
