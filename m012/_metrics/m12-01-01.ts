...
export const metric: MetricDefinitionGithub = {
  ...
  aiDescription: {
    ...
    interpretation: {
      en: "Values carry each indicator's own format (count, percent, or rate). Thresholds for traffic-light colouring come from the indicator dictionary.",
      fr: "Les valeurs portent le format propre à chaque indicateur (effectif, pourcentage ou taux). Les seuils de coloration feu tricolore proviennent du dictionnaire d'indicateurs.",
      pt: "Os valores têm o formato próprio de cada indicador (contagem, percentagem ou taxa). Os limiares para a coloração tipo semáforo provêm do dicionário de indicadores.",
    },
    typicalRange: {
