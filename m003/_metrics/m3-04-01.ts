...
export const vizPresets: VizPreset[] = [
  {
    ...
    label: {
      ...
      pt: "Perturbações e excedentes (uma única Área administrativa 2, várias Áreas administrativas 3, vários indicadores)",
    },
    description: {
      ...
      pt: "Gráfico de áreas que mostra o volume de serviços real vs esperado, para uma única Área administrativa 2, com várias Áreas administrativas 3 e vários indicadores",
    },
  ...
  },
  {
    ...
    label: {
      ...
      pt: "Perturbações e excedentes (uma única Área administrativa 3, vários indicadores)",
    },
    description: {
      ...
      pt: "Gráfico de áreas que mostra o volume de serviços real vs esperado, para uma única Área administrativa 3 e vários indicadores",
    },
