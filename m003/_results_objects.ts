...
export const resultsObjects: ResultsObjectDefinitionJSON[] = [
  {
    ...
    "description": "Service utilization data with adjusted volumes for all adjustment scenarios",
  ...
  },
  {
    ...
    "description": "Shortfall and surplus calculations for all indicators (Admin area 1)"
  },
  {
    "id": "M3_all_indicators_shortfalls_admin_area_2.csv",
    "description": "Shortfall and surplus calculations for all indicators (Admin area 2)"
  },
  {
    "id": "M3_all_indicators_shortfalls_admin_area_3.csv",
    "description": "Shortfall and surplus calculations for all indicators (Admin area 3)"
  },
  {
    "id": "M3_all_indicators_shortfalls_admin_area_4.csv",
    "description": "Shortfall and surplus calculations for all indicators (Admin area 4)"
  }
];
