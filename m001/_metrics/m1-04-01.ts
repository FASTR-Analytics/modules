...
export const vizPresets: VizPreset[] = [
  ...
  ///////////////////////////////////////////////
  {
    ...
    label: {
      ...
      pt: "Tabela da pontuação global de AQD",
    },
    description: {
      ...
      pt: "Tabela que mostra as pontuações de AQD por Área Administrativa 2 e ano",
    },
    ...
    config: {
      ...
      t: {
        ...
        subCaption: {
          ...
          pt: "Percentagem de meses-unidade sanitária com qualidade de dados adequada ao longo do tempo, INTERVALO_DE_DATAS",
        },
        footnote: {
          ...
          pt: "A qualidade de dados adequada é definida como: 1) Ausência de dados em falta ou de valores atípicos para OPD, Penta1 e ANC1, quando disponíveis 2) Notificação coerente entre Penta1/Penta3 e ANC1/ANC4.",
        },
  ...
  ///////////////////////////////////////
  {
    ...
    label: {
      ...
      pt: "Mapa da pontuação global de AQD",
    },
    description: {
      en: "Map showing DQA scores by Admin Area 2",
      fr: "Carte montrant les scores EQD par Zone administrative 2",
      pt: "Mapa que mostra as pontuações de AQD por Área Administrativa 2",
    },
    ...
    config: {
      ...
      t: {
        ...
        subCaption: {
          ...
          pt: "Percentagem de meses-unidade sanitária com qualidade de dados adequada, INTERVALO_DE_DATAS",
        },
        footnote: {
          en: "Adequate data quality is defined as: 1) No missing data or outliers for OPD, Penta1, and ANC1, where available 2) Consistent reporting between Penta1/Penta3 and ANC1/ANC4.",
          fr: "La qualité adéquate des données est définie comme : 1) Pas de données manquantes ou de valeurs aberrantes pour OPD, Penta1 et ANC1, lorsque disponibles 2) Déclaration cohérente entre Penta1/Penta3 et ANC1/ANC4.",
...
export const metric: MetricDefinitionGithub = {
  ...
  label: {
    ...
    pt: "Proporção de unidades sanitárias com qualidade de dados adequada",
  },
  ...
  aiDescription: {
    summary: {
      ...
      pt: "Proporção de unidades sanitárias que atingem o limiar da avaliação composta da qualidade dos dados.",
    },
    methodology: {
      ...
      pt: "MÉDIA da pontuação binária dqa_score baseada na avaliação composta da completude, dos valores atípicos e da coerência.",
    },
    interpretation: {
      ...
      pt: "Valores mais elevados indicam mais unidades sanitárias com dados fiáveis. As unidades sanitárias abaixo do limiar podem necessitar de apoio adicional ou de verificação dos dados.",
    },
    typicalRange: {
      ...
      pt: "70-100% é aceitável; <70% indica problemas de qualidade generalizados.",
    },
    caveats: {
      ...
      pt: "Os pesos da pontuação composta podem necessitar de ajuste consoante o contexto local. Considere os componentes individuais para um diagnóstico detalhado.",
    },
    disaggregationGuidance: {
      ...
      pt: "Desagregar por admin_area para identificar regiões que necessitam de apoio à melhoria da qualidade. Utilizar facility_type para verificar se determinados níveis de unidade sanitária têm mais dificuldades.",
    },
  },
  variantLabel: null,
