...
const vizPresets: VizPreset[] = [
  {
    ...
    label: {
      en: "Observed vs expected with 95% credible interval",
      fr: "Observé vs attendu avec intervalle de crédibilité à 95%",
    },
    description: {
      en: "Four plain lines per indicator: observed, expected, lower and upper 95% credible bounds, by month. No additional formatting.",
      fr: "Quatre lignes simples par indicateur : observé, attendu, bornes inférieure et supérieure de l'intervalle de crédibilité à 95%, par mois. Aucune mise en forme supplémentaire.",
    },
...
export const metric: MetricDefinitionGithub = {
    id: "m11-01-01",
    resultsObjectId: "M11_disruptions_analysis_admin_area_1.csv",
    variantLabel: {
      en: "National",
      fr: "National",
    },
    ...
    aiDescription: {
      ...
      useCases: [
        {
          en: "Detect real service disruptions distinct from reporting gaps",
          fr: "Détecter les vraies perturbations de service distinctes des écarts de complétude",
        },
        {
          en: "Quantify service shortfall during crises with credible intervals",
          fr: "Quantifier le déficit de service pendant les crises avec intervalles de crédibilité",
        },
        {
          en: "Compare disruption magnitude across regions and indicators",
          fr: "Comparer l'ampleur des perturbations entre régions et indicateurs",
        },
      ],
      relatedMetrics: ["m3-01-01"],
