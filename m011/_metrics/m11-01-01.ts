...
const vizPresets: VizPreset[] = [
  {
    ...
    description: {
      en: "Observed (solid) and expected (dashed) lines per indicator, by month, over a grey 95% credible band — green shading where observed rises above the band, red where it falls below.",
      fr: "Lignes observée (pleine) et attendue (pointillée) par indicateur, par mois, sur une bande de crédibilité grise à 95% — ombrage vert où l'observé dépasse la bande, rouge où il tombe en dessous.",
    },
